...
gallery.buildHTML = function galleryBuildHTML(container) {
  ...
  var $galleryInner = $('<div />').addClass('gallery__inner').appendTo(container);

  $('<button />').addClass('gallery__nav--prev').appendTo(container);

  $('<button />').addClass('gallery__nav--next').appendTo(container);
};
...
gallery.createSlides = function galleryCreateSlides() {
  ...
  $.each($slides, function () {
    ...
    var slide = $('<div />').addClass('gallery__slide').append($('<img />', {
      src: this
...
var photos = ['http://placehold.it/350x150', 'http://placehold.it/350x150', 'http://placehold.it/350x150'];
...
},{"./gallery.js":2}],4:[function(require,module,exports){
